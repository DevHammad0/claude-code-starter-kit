 ...
 * Tracks token counts and estimated USD cost per session so you can monitor
 * API spend during active NearMe development.
 */
...
function estimateCost(model, inputTokens, outputTokens) {
  // Approximate per-1M-token blended rates
  const table = {
