#!/usr/bin/env node
/**
 * Stop Hook: Session End — Persist session state after each response
 *
 * Cross-platform (Windows, macOS, Linux)
 *
 * Runs on Stop events (after each Claude response). Reads the session
 * transcript to extract a meaningful summary (tasks requested, tools used,
 * files modified) and writes/updates a session file in ~/.claude/sessions/.
 *
 * This gives you cross-session continuity when working on NearMe across
 * multiple days — session-start.js picks this up at the next session.
 */
 ...
 * Reads the JSONL transcript and pulls out:
